...
export default function HospitalServiceQuickEditForm({
  currentHospitalService,
  open,
  onClose,
  refreshHospitalServices,
}) {
  console.log('currentHospitalService',currentHospitalService);
  console.log('currentHospitalService',open);
  ...
  () => ({
    ...
    isActive: currentHospitalService?.isActive ? '1' : '0' || '',
  }),
  [currentHospitalService]
);
  ...
  return (
    ...
    >
      <FormProvider methods={methods} onSubmit={onSubmit}>
        ...
        <DialogContent>
          {!currentHospitalService?.isActive && (
          ...
          >
            ...
            <RHFTextField name="hospitalService" label="HospitalService" />
...
HospitalServiceQuickEditForm.propTypes = {
  currentHospitalService: PropTypes.object,
  onClose: PropTypes.func,
  open: PropTypes.bool,
  refreshHospitalServices: PropTypes.func,
};
