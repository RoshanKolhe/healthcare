        ...
        <Grid xs={12} md={12}>
          <Card sx={{ p: 3,pt: 10, }}>
            ...
            >
              ...
              <RHFTextField name="hospitalName" label="Hospital Name" disabled/>
              <RHFTextField name="hospitalRegNum" label="Hospital Register Number" disabled/>
              <RHFTextField name="hospitalCategory" label="Hospital Category" disabled/>
              <RHFTextField name="hospitalType" label="Hospital Type" disabled/>
              <RHFTextField name="hospitalServices" label="Hospital Services" disabled/>
              <Stack spacing={1.5}>
