...
export default function UserTableRow({
  ...
  const { clinicService, description, isActive } = row;
  ...
  return (
    <>
      <TableRow hover selected={selected}>
        <TableCell sx={{ whiteSpace: 'nowrap' }}>{clinicService}</TableCell>
        ...
        <TableCell align="right" sx={{ px: 1, whiteSpace: 'nowrap' }}>
          ...
          {/* <Tooltip title="Edit ClinicService" placement="top" arrow>
            <MenuItem
              onClick={() => {
                onEditRow();
                popover.onClose();
