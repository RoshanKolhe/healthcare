...
export default function DoctorQuickEditForm({ currentDoctor, open, onClose, refreshDoctors }) {
  ...
  const defaultValues = useMemo(
    () => ({
      ...
      isActive: currentDoctor?.isActive ? '1' : '0' || '',
    }),
    [currentDoctor]
  );
...
DoctorQuickEditForm.propTypes = {
  currentDoctor: PropTypes.object,
  onClose: PropTypes.func,
  open: PropTypes.bool,
  refreshDoctors: PropTypes.func,
};
