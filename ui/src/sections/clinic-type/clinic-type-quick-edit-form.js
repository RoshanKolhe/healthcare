...
export default function ClinicTypeQuickEditForm({
  currentClinicType,
  open,
  onClose,
  refreshClinicTypes,
  ...
  console.log('currentClinicType',open);
  ...
  () => ({
    ...
    isActive: currentClinicType?.isActive ? '1' : '0' || '',
  }),
  [currentClinicType]
);
...
ClinicTypeQuickEditForm.propTypes = {
  currentClinicType: PropTypes.object,
  onClose: PropTypes.func,
  open: PropTypes.bool,
  refreshClinicTypes: PropTypes.func,
};
