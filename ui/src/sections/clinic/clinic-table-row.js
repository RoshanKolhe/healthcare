      ...
      <TableRow hover selected={selected}>
        <TableCell sx={{ whiteSpace: 'nowrap' }}>
          <Stack direction="row" spacing={1} alignItems="center">
            <Avatar src={imageUpload?.fileUrl} alt={clinicName} />
            <Typography variant="body2" noWrap>
              {clinicName}
            </Typography>
          </Stack>
        </TableCell>
        <TableCell sx={{ whiteSpace: 'nowrap' }}>{clinicRegNum}</TableCell>
        <TableCell sx={{ whiteSpace: 'nowrap' }}>{category?.category || 'N/A'}</TableCell>
        <TableCell sx={{ whiteSpace: 'nowrap' }}>{clinicType?.clinicType || 'N/A'}</TableCell>
        <TableCell sx={{ whiteSpace: 'nowrap' }}>{clinicService?.clinicService || 'N/A'}</TableCell>
