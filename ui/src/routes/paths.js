...
export const paths = {
  ...
  auth: {
    ...
    jwt: {
      ...
      hospitalLogin: `${ROOTS.AUTH}/jwt/hospital/login`,
      hospitalRegister: `${ROOTS.AUTH}/jwt/hospital/register`,
      hospitalNewPassword: `${ROOTS.AUTH}/jwt/hospital/new-password`,
      hospitalForgotPassword: `${ROOTS.AUTH}/jwt/hospital/forgot-password`,
    },
    firebase: {
  ...
  dashboard: {
    ...
    hospital: {
      ...
      list: `${ROOTS.DASHBOARD}/hospitals/list`,
      profile: `${ROOTS.DASHBOARD}/hospitals/profile`,
    ...
    hospitalType: {
      root: `${ROOTS.DASHBOARD}/hospital-types`,
      new: `${ROOTS.DASHBOARD}/hospital-types/new`,
      list: `${ROOTS.DASHBOARD}/hospital-types/list`,
      profile: `${ROOTS.DASHBOARD}/hospital-types/profile`,
